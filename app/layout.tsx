...
export const metadata: Metadata = {
  ...
  description:
    "Tặng phụ huynh 5 buổi đào tạo Robotics cơ bản trên phần mềm RoboSim cho học sinh lớp 1-8. 12 suất MIỄN PHÍ mỗi cơ sở. Khai giảng đợt mới mỗi Thứ 7 tại 211 Nguyễn Hữu Thọ và 114 Hoàng Diệu, Đà Nẵng.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "5 buổi học Robotics đại cương MIỄN PHÍ cho con — chỉ 12 suất/cơ sở. Khai giảng đợt mới mỗi Thứ 7 tại Đà Nẵng.",
    url: SITE_URL,
    siteName: "Sata Robo",
    images: [
      {
